...
INSERT INTO `paqueteturistico` (`id`, `nombre`, `direccion`, `duracion`) VALUES
	(1, 'Playas del Norte', 'Piura', 4),
	(2, 'Playas del Norte', 'Tumbes', 4),
	(3, 'Ciudades de Europa', 'Francia', 14),
	(4, 'Aventura en la Selva', 'Iquitos', 7),
	(5, 'Explorando las Ruinas', 'Cusco', 5),
	(6, 'Playas del Sur', 'Lima', 3),
	(7, 'Tour de Vinos', 'Mendoza', 2),
	(8, 'Safari en África', 'Kenia', 10),
	(9, 'Islas Exóticas', 'Maldivas', 7),
	(10, 'Aventura en la Montaña', 'Machu Picchu', 4),
	(11, 'Ruta del Vino', 'Valle de Guadalupe', 3),
	(12, 'Ski en los Alpes', 'Suiza', 7),
	(13, 'Tour de Templos', 'Tailandia', 10);
