...
<body class>
    <div class="lg:flex">
            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                ...
                <div class="mt-12">
                    <form>
                        <div>
                            ...
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                type="" placeholder="Enter your full name">
                        </div>
                        <div class="mt-8">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Email</div>
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                type="" placeholder="Example@gmail.com">
                        </div>
                        <div class="mt-8">
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Already have an account? <a href="login.php" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Log in</a>
                    </div>
        ...
        <div class="hidden lg:flex items-center justify-center bg-indigo-100 flex-1 h-screen">
            <img src="img/banner-avion.jpg" alt="">
        </div>
    </div>
