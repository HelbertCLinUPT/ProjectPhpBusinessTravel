            ...
            <div class="py-6 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <a href="index.php">
                    <div class="cursor-pointer flex items-center">
                        <div>
                            <img src="img/LogoEmpresa.png" class="h-10 w-auto" alt="logo">
                        </div>
            ...
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                ...
                <div class="mt-12">
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Don't have an account ? <a href="register.php" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign
                            up</a>
                    </div>
