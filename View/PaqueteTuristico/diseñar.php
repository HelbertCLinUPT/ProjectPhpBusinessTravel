...
<body id="page-top">
    <div id="wrapper">
        ...
        <h4>Rol del bot:</h4>      
                                                        ...
                                                        <select id="opciones-select" class="w-full bg-white border border-gray-300 rounded-md px-3 py-2 outline-none">
...
<input id="rolBot" type="text" value="Asistente de Viajes" class="flex w-full border rounded-xl focus:outline-none focus:border-indigo-300 pl-4 h-10" name="rol" placeholder="Rol Bot" readonly>
