                                                ...
                                                <div class="w-3/12">
                                                    <div class="rounded-xl bg-white py-3 px-3">
                                                        ...
                                                        <a style="text-decoration: none;" href="MainController.php?action=paquete-disenar-img">
                                                            <button class=" mt-6 bg-indigo-600 hover:bg-indigo-700 text-white w-full py-2 px-4 mb-2 rounded-xl shadow-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50 flex items-center justify-center">
                                                                <span class="mr-2">New image</span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="ml-2 bi bi-brush" viewBox="0 0 16 16">
