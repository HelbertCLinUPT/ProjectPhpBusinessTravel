...
<body>
    ...
    <form method="POST" action="MainController.php?action=reservainter-add">
        <label for="nombre">Nombre:</label>
        <input type="text" name="nombre" required><br>
        <label for="precio_total">Precio Total:</label>
        <input type="text" name="precio_total" required><br>
        <label for="id_usuario">ID Usuario:</label>
        <input type="text" name="id_usuario" required><br>
        <label for="id_servicio">ID Servicio:</label>
        <input type="text" name="id_servicio" required><br>
