                            ...
                            <div class="row">
                                <div class="col-lg-7 w-100">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="POST" action="MainController.php?action=usuario-edit&id=<?php echo $usuario->getId(); ?>" id="edit-form">
                                            <div class="form-group row">
                                                <label for="nombre" class="col-sm-3 col-form-label">Nombre:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control form-control-user" name="nombre" style="font-size: 18px;" value="<?php echo $usuario->getNombre(); ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="apellido" class="col-sm-3 col-form-label">Apellido:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control form-control-user" style="font-size: 18px;" name="apellido" value="<?php echo $usuario->getApellido(); ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
